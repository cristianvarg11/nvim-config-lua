    ...
    config = function()
        ...
        vim.api.nvim_create_autocmd("LspAttach", {
            ...
            callback = function(ev)
				...
				opts.desc = "Fix all auto-fixable ESLint problems"
				vim.keymap.set("n", "<leader>ef", function()
						vim.lsp.buf.code_action({
								context = {
										only = { "source.fixAll.eslint" }, -- Explicitly request ESLint's fixAll
										diagnostics = vim.diagnostic.get(0), -- Pass current diagnostics for context
								},
								apply = true, -- Automatically apply the first (and hopefully only) result
						})
				end, opts)
            end,
        })
        ...
        lspconfig.ts_ls.setup({
            ...
            init_options = {
				...
				-- ADD THIS NEW SECTION FOR ESLINT LSP
        lspconfig.eslint.setup({
            ...
            settings = {
                eslint = {
                    ...
                    -- IMPORTANT: Keep this false if Conform/Prettier is handling formatting
                    -- If true, ESLint will also try to format, which might conflict with Prettier.
                    -- We want ESLint for linting/diagnostics, and Conform for formatting.
                    format = {
                        enable = false,
                    },
                    rules = {
                    ...
                    -- Specify filetypes for ESLint to validate
                    validate = {
                        "javascript",
                        "javascriptreact",
                        "typescript",
                        "typescriptreact",
                        "vue", -- Add other relevant filetypes if you use them
                        "html",
                        "json",
                        "yaml",
                        "markdown",
